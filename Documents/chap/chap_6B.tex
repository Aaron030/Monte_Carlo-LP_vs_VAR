...
Three limitations bound these conclusions. First, the full VAR sweep up to $VAR(23)$ makes the
smallest samples infeasible, since the high-order systems turn rank-deficient and unstable,
